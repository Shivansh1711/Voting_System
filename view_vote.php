        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <?php 
                    // Fetch categories associated with the voting poll
                    ...
                    ?>
                        ...
                        <div class="row mt-3">
                            <?php 
                            // Fetch all the candidates for this category
                            $category_opts = $conn->query("SELECT * FROM voting_opt WHERE voting_id = $id AND category_id = ".$row['id']);
                            while ($opt = $category_opts->fetch_assoc()):
                            ?>
                                <div class="candidate" style="position: relative;">
                                    <div class="item">
                                        <div style="display: flex">
                                            <img src="assets/img/<?php echo $opt['image_path'] ?>" alt="">
                                        </div>
                                        <br>
                                        <div class="text-center">
                                            <large><b><?php echo ucwords($opt['opt_txt']) ?></b></large>
                                        </div>
                                    </div>
                                </div>
                            <?php endwhile; ?>
